...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        //Task 2:
        public Engine(IRenderer renderer, IUserInterface userInterface, int timeSleep)
        ...
        {
            //Task 3:
            this.allObjects.RemoveAll(o => o is Racket);
            this.staticObjects.RemoveAll(o => o is Racket);
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep(this.timeSleep);
