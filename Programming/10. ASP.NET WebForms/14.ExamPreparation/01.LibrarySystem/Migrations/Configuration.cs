namespace _01.LibrarySystem.Migrations
{
        ...
        protected override void Seed(LibraryDbContext context)
        {
            ...
            List<Book> books = new List<Book>()
            {
                new Book() { 
                    ...
                    Site = "http://www.introprogramming.info/english-intro-csharp-book/",
                ...
                new Book() { 
                    ...
                    Site = "http://www.csharpcourse.com",
                ...
                new Book() { 
                    ...
                    Site = "http://www.programirane.org",
                ...
                new Book() { 
                    ...
                    Author = "Imar Spaanjaars", Site="http://www.goodreads.com/book/show/17129477",
                    Category = categories[2]
                },
                new Book() { 
                    Title = "Advanced Linux Programming",
                    Author = "CodeSourcery LLC", Site="http://www.advancedlinuxprogramming.com",
