<%@ Page Title="EditDeleteMessages" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditDeleteMessages.aspx.cs" Inherits="WebFormsChat.Admin.EditDeleteMessages" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Edit/Delete Messages</h1>
    <asp:ListView 
        runat="server" 
        ID="MessagesListView" 
        ...
        DeleteMethod="MessagesListView_DeleteItem" 
