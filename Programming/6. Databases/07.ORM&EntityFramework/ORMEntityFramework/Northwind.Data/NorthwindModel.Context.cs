...
namespace Northwind.Data
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> IncomeFromSupplierAndPeriod(Nullable<System.DateTime> start, Nullable<System.DateTime> end, Nullable<int> supplierId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("IncomeFromSupplierAndPeriod", startParameter, endParameter, supplierIdParameter);
        }
        ...
        public virtual ObjectResult<IncomeFromSupplierAndPeriod_Result> IncomeForSupplierAndPeriod(Nullable<System.DateTime> start, Nullable<System.DateTime> end, Nullable<int> supplierId)
        {
            var startParameter = start.HasValue ?
                new ObjectParameter("start", start) :
                new ObjectParameter("start", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<IncomeFromSupplierAndPeriod_Result>("IncomeForSupplierAndPeriod", startParameter, endParameter, supplierIdParameter);
        }
    }
}
